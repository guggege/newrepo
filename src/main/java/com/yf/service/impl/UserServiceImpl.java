...
import com.yf.common.utils.JwtUtil;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public Map<String, Object> getUserInfo(String token) {
        ...
        if(loginUser != null){
            //User loginUser = JSON.parseObject(JSON.toJSONString(loginUser), User.class);
    ...
    //    List<SysOrder> userEntityIPage = orderMapper.getorder();
